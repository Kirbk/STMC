...
void EditorScreen::onEntry() {
	m_spriteFont.init("Assets/fonts/Oswald-SemiBold.ttf", 32);
	...
	m_blankTexture = Engine::ResourceManager::getTexture("Assets/textures/block.png");
}
...
void EditorScreen::drawUI() {
	...
	{ // Draw the color picker quad
		...
		m_spriteFont.draw(m_spriteBatch, colorText.c_str(), glm::vec2(destRect.x + destRect.z * 0.5f, destRect.y + destRect.w), glm::vec2(0.4f), 0.0f, Engine::ColorRGBA8(255, 255, 255, 255), Engine::Justification::MIDDLE);
	}
...
void EditorScreen::updateMouseDown(const SDL_Event& evnt) {
	...
	static Engine::GLTexture texture = Engine::ResourceManager::getTexture("Assets/textures/block.png");
	glm::vec2 pos;
	glm::vec4 uvRect;
